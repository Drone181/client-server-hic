          ...
          {posts[1] && <div className="lg:h-1/3 flex justify-between gap-4">
            ...
            <div className="w-2/3">
              ...
              <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                ...
                <Link className="text-blue-800">{posts[1].categpry}</Link>
                <span className="text-gray-500 text-sm ">{format(posts[1].createdAt)}</span>
              </div>
              {/*title*/}
              <Link to={posts[1].slug} className="text-base sm:text-lg md:text-2xl lg:text-lg xl:text-2xl font-medium">
                {posts[1].title}
              </Link>
            </div>
          </div>}
          ...
          {posts[2] && <div className="lg:h-1/3 flex justify-between gap-4">
            ...
            <div className="w-2/3">
              ...
              <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                ...
                <Link className="text-blue-800">{posts[2].categpry}</Link>
                <span className="text-gray-500 text-sm ">{format(posts[2].createdAt)}</span>
              </div>
              {/*title*/}
              <Link to={posts[2].slug} className="text-base sm:text-lg md:text-2xl lg:text-lg xl:text-2xl font-medium">
                {posts[2].title}
              </Link>
            </div>
          </div>}
          ...
          {posts[3] && <div className="lg:h-1/3 flex justify-between gap-4">
            ...
            <div className="w-2/3">
              ...
              <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                ...
                <Link className="text-blue-800">{posts[3].categpry}</Link>
                <span className="text-gray-500 text-sm ">{format(posts[3].createdAt)}</span>
              </div>
              {/*title*/}
              <Link to={posts[3].slug} className="text-base sm:text-lg md:text-2xl lg:text-lg xl:text-2xl font-medium">
                {posts[3].title}
              </Link>
            </div>
          </div>}
